...
OUT = Path(r"C:\Users\aw4wz\Documents\Codex\TLaser\SuzhouIndustrialPark_TLaser_revised_0810_GuJun.docx")
...
def set_cell_text(cell, text, size=10.5):
    cell.text = ""
    set_paragraph_text(cell.paragraphs[0], text, size=size)
...
def fill_gu_jun(table):
    set_cell_text(table.cell(0, 1), "顾俊")
    set_cell_text(table.cell(0, 5), "待补充")
    set_cell_text(table.cell(1, 1), "男")
    set_cell_text(table.cell(1, 5), "中国")
    set_cell_text(table.cell(2, 5), "仿真技术经理；CAE解决方案与商务拓展")
    set_cell_text(table.cell(3, 1), "本科及以上（待确认）")
    set_cell_text(table.cell(3, 5), "待补充")
    set_cell_text(table.cell(4, 1), "工学")
    set_cell_text(table.cell(4, 5), "CFD仿真、热管理、动力系统解决方案")
    set_cell_text(table.cell(5, 3), "□身份证  □护照号（待补充）")
    set_cell_text(table.cell(5, 8), "待补充")
    set_cell_text(table.cell(6, 3), "□有  ☑无（公开资料未见海外经历）")
    set_cell_text(table.cell(6, 8), "深圳/华南（待确认）")
    ...
    set_cell_text(table.cell(9, 3), "拟作为公司全职商务负责人，负责客户开发、试点合作、解决方案包装、销售渠道、合同谈判和回款。")
    set_cell_text(table.cell(10, 3), "待补充")
    set_cell_text(table.cell(10, 8), "待补充")
    set_cell_text(table.cell(13, 0), "约2021年前后")
    set_cell_text(table.cell(13, 2), "待补充")
    set_cell_text(table.cell(13, 4), "苏州舜云工程软件有限公司/舜云科技")
    set_cell_text(table.cell(13, 7), "仿真技术经理")
    set_cell_text(table.cell(14, 0), "此前")
    set_cell_text(table.cell(14, 2), "待补充")
    set_cell_text(table.cell(14, 4), "汽车工程/动力系统相关企业")
    set_cell_text(table.cell(14, 7), "前舱热管理、动力系统 CFD 仿真及热管理工程师")
    for r in [15, 16]:
        set_cell_text(table.cell(r, 0), "")
        set_cell_text(table.cell(r, 2), "")
        set_cell_text(table.cell(r, 4), "")
        set_cell_text(table.cell(r, 7), "")
    ...
    set_cell_text(
        table.cell(26, 0),
        "就业经历和业绩：公开资料显示，顾俊先生曾任苏州舜云工程软件有限公司仿真技术经理，曾从事前舱热管理仿真、动力系统 CFD 仿真及热管理相关工作，负责舜云科技动力系统模块解决方案研发及推广，并完成汽车行业多个头部企业的飞溅润滑及热管理分析技术移交工作，具备汽车工程领域仿真与设计经验。公开会议资料还显示，其曾以舜云科技专家身份分享“电驱动系统虚拟温度模型”等议题，说明其具备把复杂仿真技术转化为客户解决方案和市场推广内容的能力。\n\n与本项目关联：TLaser 早期商业化需要把算法原型包装成客户可理解、可试点、可采购的解决方案。顾俊先生拟担任商务负责人，重点负责深圳/华南及苏州客户开发、试点项目商务推进、客户需求转化、解决方案材料、合同回款和渠道合作，补足团队在市场开拓、客户沟通和商业闭环方面的能力。"
    )
...
summary = (
    "1）团队优势：项目由万振文全职牵头。万振文为中科院博士、国家级人才，曾任厦门大学副教授、丹麦气象研究所资深研究员，近十年聚焦 CAE/工业软件算法创业，完成 EML、MySim 等软件和多项客户合同交付，已取得 3 项发明专利授权。顾俊先生拟全职担任商务负责人，公开资料显示其曾任苏州舜云工程软件有限公司仿真技术经理，负责动力系统模块解决方案研发及推广，并完成汽车行业多个头部企业热管理分析技术移交，具备仿真软件解决方案和客户推广经验。蒋寻涯教授为复旦大学研究员、博士生导师，曾入选中科院百人计划，作为兼职首席科学顾问负责光电仿真、L-I-V 测试验证技术路线和产业资源。"
    ...
    "\n5）产业化基础：现已完成模拟器、1500 组训练样本、PINN 模型、标定脚本和中英文控制面板，可开展真实客户数据接入和联合验证。优先服务苏州园区及苏州光通信产业链企业，再复制到长三角和深圳/华南客户。"
...
set_cell_text(
    t3.cell(3, 0),
    "万振文：拟全职，CEO/CTO，负责公司战略、核心算法、产品定义和重点客户交付。其优势是计算物理、工业软件、数值算法和创业交付经验连续，已完成多款 CAE/仿真软件原型和客户合同交付。\n顾俊：拟全职，商务负责人/COO，负责苏州、深圳及长三角客户开发，试点合作、解决方案包装、销售渠道、合同谈判和回款管理。公开资料显示，其曾任苏州舜云工程软件有限公司仿真技术经理，负责动力系统模块解决方案研发及推广，完成汽车行业多个头部企业的热管理分析技术移交，具备把仿真软件能力转化为客户解决方案和商务机会的经验。\n蒋寻涯：兼职首席科学顾问，负责半导体光电仿真、全波电磁建模、L-I-V 测试验证技术路线、产品技术路线评审和产业客户资源协同。其为复旦大学研究员、博士生导师，曾入选中科院百人计划，并推进 EastWave 国产电磁仿真软件产业化。\n团队分工形成“全职创业与技术负责人 + 全职商务负责人 + 兼职科学顾问”的结构，解决评审关注的市场开拓、产品落地和测试验证责任边界问题。"
)
set_cell_text(
    t3.cell(16, 0),
    "第一年：完成苏州公司注册，万振文和顾俊为核心全职成员落地，蒋寻涯作为兼职首席科学顾问参与技术路线和测试验证评审；完成 TLaser V1.0 工程版，接入至少 1 家苏州客户真实 L-I-V 数据，主营收入 80 万元，新增就业 5 人。\n第二年：形成多器件型号模型库和 SaaS 试点版，完成 3 家以上付费试点，主营收入 350 万元，团队 12 人。\n第三年：形成商业版和私有化部署能力，完成 6 类以上器件型号验证，主营收入 900 万元，团队 25 人。三年累计受理发明专利 5 项、PCT 2 项、软著 6 项，力争高企培育/申报和园区/市级科技项目支持。"
)

project_overview = (
    "TLaser 面向光通讯半导体激光器研发与量产测试环节，建设“数字孪生 + 在线标定 + 批次诊断”的工业软件平台。项目负责人万振文为中科院博士、国家级人才，具备科研建模、工业软件、数值算法和创业交付经验；顾俊先生拟全职负责商务拓展、客户试点、解决方案包装、渠道建设和合同交付闭环；蒋寻涯教授作为兼职首席科学顾问负责光电仿真、L-I-V 测试验证技术路线和产业资源。\n\n"
...
company_overview = (
    ...
    "落地苏州后，公司第一阶段收入来自联合验证和模型适配服务，第二阶段形成 SaaS 订阅和私有化部署授权，第三阶段扩展到光电子器件数字孪生模型库。公司早期将控制固定成本，以万振文为全职技术/产品核心、顾俊为全职商务负责人，配置算法、软件、测试和销售人员；蒋寻涯教授作为兼职首席科学顾问参与关键技术评审、测试验证路线和资源协同。"
)
replace_para_start(doc, "本项目拟以苏州麦慎数字科技有限公司作为园区产业化主体", company_overview)

stage_body = (
    "3-5 年阶段目标围绕产品、客户、团队和知识产权展开。第一年完成苏州公司注册，形成万振文、顾俊为核心的全职经营团队，完成 TLaser V1.0 工程版、真实 L-I-V 数据接入、1 家以上苏州客户联合验证，主营收入约 80 万元，申请 1 项发明专利、2 项软著，新增就业 5 人。第二年完成多型号激光器模型库、SaaS 试点版、3 家以上付费客户，主营收入约 350 万元，申请 2 项发明专利、1 项 PCT、2 项软著，新增就业至 12 人。第三年完成商业版、私有化部署和 API 接口，服务不少于 6 类器件型号，主营收入约 900 万元，新增就业至 25 人，累计形成 5 项发明专利受理、2 项 PCT、6 项软著。\n\n"
